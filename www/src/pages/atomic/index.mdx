...
<div className="pa3 ba b-gray-300 mb4 tp-body-2">
    <div className="grid">
        ...
        <div className="s_col-4 mb2 s_mb0">
            <div
                className="aspect-ratio aspect-ratio-16x9 bg-center mb1"
...
Using multiple columns with a combined width that exceeds `12` will automatically wrap into new rows.

```html
<div class="grid">
    <div class="col-4 mb3"><div class="bg-gray-200 ba b-gray h3"></div></div>
    <div class="col-4 mb3"><div class="bg-gray-200 ba b-gray h3"></div></div>
    <div class="col-4 mb3"><div class="bg-gray-200 ba b-gray h3"></div></div>
    <div class="col-4"><div class="bg-gray-200 ba b-gray h3"></div></div>
    <div class="col-4"><div class="bg-gray-200 ba b-gray h3"></div></div>
    <div class="col-4"><div class="bg-gray-200 ba b-gray h3"></div></div>
</div>
```
