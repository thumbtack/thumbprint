...
Deciding what type of animation to use is more art than science. They should be quick but not jarring. To achieve this balance we generally use short durations for animations with smaller items moving smaller distances. Larger objects moving larger distances will use longer durations.

#### Examples

The following interactive examples are based on interactions that exist in Thumbtack products.
...
Click examples to toggle animations.
