...
Note that the transition speeds used in these examples has been slowed to better convey how the transition works.
...
<div className="grid">
    <div className="col-4">
        ...
        <Text size={2}>
            This “pushes” one page out of the way for the other, sliding in from the right to go
            deeper into the UI.
        </Text>
    </div>
    <div className="col-4">
