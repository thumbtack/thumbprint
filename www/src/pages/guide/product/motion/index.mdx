...
import IosPush from 'components/page-transitions/ios/push';
...
Creates a stack effect with the new page coming from the bottom and over the parent page.

<img src="./ios-push.gif" class="ba b-black-300 br2" />
