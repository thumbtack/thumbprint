...
1. Strings 1 line long with an ellipsis with no UI action to expand what's been truncated.
2. Strings between 2 and 3 lines long with an ellipsis with no UI action to expand what's been truncated.
...
<div class="bg-gray dib tc mt3 pa6">[JK EXAMPLE HERE]</div>
