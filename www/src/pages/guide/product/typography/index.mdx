...
| -------------------- | ---------------------------- | ----------- | ----------- | ----------- |
| `<Title size={1} />` | <ContentActionsCheckSmall /> | `28px/40px` | `32px/44px` | `700`       |
| `<Title size={2} />` | <ContentActionsCheckSmall /> | `24px/32px` | `28px/40px` | `700`       |
| `<Title size={3} />` | <ContentActionsCheckSmall /> | `22px/24px` | `28px/32px` | `700`       |
...
<Alert type="note" title="HTML headings">
    Though numbered 1 though 5 our "Title" components are independent of the HTML heading elements
    h1-h6. Use the <InlineCode>size</InlineCode> required by the design with the appropriate
