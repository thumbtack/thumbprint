...
<UsageImg>
    <Img src="./anatomy.png" alt="Anatomy of the pill component" width="168px" />
</UsageImg>
...
<UsageImg>
    <Img
        src="./color-primary.png"
        alt="Specifications for the pill component colors"
        width="182px"
    />
</UsageImg>
<Text size={2} className="black-300">
...
<UsageImg>
    <Img src="./color-solid.png" alt="Specifications for the pill component colors" width="189px" />
</UsageImg>
<Text size={2} className="black-300">
