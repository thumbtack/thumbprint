...
Buttons change width depending on the content inside of them and have three variations: Primary, Tertiary and Caution.
...
<Alert type="warning" title="Where's the secondary theme?" className="mt5">
    The <InlineCode>secondary</InlineCode> theme has been renamed to{' '}
    <InlineCode>tertiary</InlineCode>. This is to prep for a redesigned{' '}
    <InlineCode>secondary</InlineCode> button.{' '}
...
There are two button sizes, Large and Small. Almost always, the Large size should be used.
