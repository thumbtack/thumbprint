...
These loading indicators should be used when buttons are processing. They are avialble in the `primary` and `tertiary` button themes.
...
export const pageQuery = graphql`
    {
        ...
        reactComponentProps: file(
            relativePath: { eq: "thumbprint-react/components/Button/index.jsx" }
        ) {
