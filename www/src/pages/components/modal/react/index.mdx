...
export const pageQuery = graphql`
    {
        ...
        platformNav: allSitePage(filter: { path: { glob: "/components/modal/*/" } }) {
            edges {
                node {
                    ...PlatformNavFragment
                }
        ...
        reactComponentProps: allFile(
            filter: { relativePath: { in: ["thumbprint-react/components/Modal/index.tsx"] } }
        ) {
            ...ReactComponentPropsFragment
        }
        tableOfContents: file(relativePath: { eq: "components/modal/react/index.mdx" }) {
            childMdx {
                headings {
                    value
                    depth
