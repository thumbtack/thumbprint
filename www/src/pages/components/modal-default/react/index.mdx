...
<Alert type="warning" title="This component will be renamed">
    The <InlineCode>ModalDefault</InlineCode> React components component will be renamed to{' '}
    <InlineCode>Modal</InlineCode> in early December.
                ...
                <ModalContent>
                    <ol className="tp-form-fields">
                        <li className="tp-form-field__item">
                            ...
                            <Dropdown value="default" isFullWidth onChange={() => {}}>
...
function ModalDefaultDemoFixedHeight() {
    ...
    return (
        <React.Fragment>
            ...
            >
                <ModalHeader>
                    <ModalTitle>{showIntroScreen ? 'First screen' : 'Second screen'}</ModalTitle>
                </ModalHeader>
