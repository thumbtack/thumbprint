...
```html
<div class="tp-alert tp-alert--banner tp-alert--warning-500">
    <div class="tp-alert__text">
        Your credit card is about to expire. To keep quoting on job requests please
        <a href="https://example.com/">update your credit card now</a>.
    </div>
...
```html
<div class="tp-alert tp-alert--banner tp-alert--warning-600">
    <div class="tp-alert__text">
        Your credit card is about to expire. To keep quoting on job requests please
        <a href="https://example.com/">update your credit card now</a>.
    </div>
...
### Yellow 600 text with yellow 300 background

```html
<div class="tp-alert tp-alert--banner tp-alert--warning-600-300">
    <div class="tp-alert__text">
        Your credit card is about to expire. To keep quoting on job requests please
        <a href="https://example.com/">update your credit card now</a>.
    </div>
...
### Yellow 600 text with yellow 200 background

```html
<div class="tp-alert tp-alert--banner tp-alert--warning-600-200">
    <div class="tp-alert__text">
        Your credit card is about to expire. To keep quoting on job requests please
        <a href="https://example.com/">update your credit card now</a>.
    </div>
...
### Yellow 600 text with yellow 100 background

```html
<div class="tp-alert tp-alert--banner tp-alert--warning-600-100">
    <div class="tp-alert__text">
        Your credit card is about to expire. To keep quoting on job requests please
        <a href="https://example.com/">update your credit card now</a>.
    </div>
