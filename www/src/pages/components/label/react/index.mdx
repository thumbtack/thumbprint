...
<React.Fragment>
    ...
    <TextInput id="example-49293" onChange={() => {}} placeholder="example@example.com" />
</React.Fragment>
```
...
<React.Fragment>
    ...
    <TextInput id="example-083109" hasError value="example@exampl" onChange={() => {}} />
    <div className="mb1">
...
export const pageQuery = graphql`
    {
        ...
        reactComponentProps: allFile(
            filter: { relativePath: { in: ["thumbprint-react/components/Label/index.tsx"] } }
        ) {
            ...ReactComponentPropsFragment
        }
        tableOfContents: file(relativePath: { eq: "components/label/react/index.mdx" }) {
            childMdx {
                headings {
                    value
                    depth
