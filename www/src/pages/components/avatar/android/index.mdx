...
<Alert type="note" title="Android components are not currently open source">
    While this component's source code is private, we've made the documentation public for those interested in how we design and document our mobile components.
</Alert>
