...
<React.Fragment>
    ...
    <TextInput id="example-39189" type="password" onChange={() => {}} />
    <div className="mt1">
...
<React.Fragment>
    ...
    <TextInput id="example-291929" hasError value="example@exampl" onChange={() => {}} />
    <div className="mt1">
...
export const pageQuery = graphql`
    {
        ...
        reactComponentProps: allFile(
            filter: { relativePath: { in: ["thumbprint-react/components/FormNote/index.tsx"] } }
        ) {
            ...ReactComponentPropsFragment
        }
        tableOfContents: file(relativePath: { eq: "components/form-note/react/index.mdx" }) {
            childMdx {
                headings {
                    value
                    depth
