...
`Pills` are also considered read-only and non-interactive.
...
<Wrap className="pb4">
    <Grid gutter="wide">
        <GridColumn aboveSmall={6}>
            <DoDont type="do">
                <Img src="./pill-do-a11y.png" alt="Pill accessibility color do examples" className="ma-auto" />
            </DoDont>
        ...
        <GridColumn aboveSmall={6}>
            <DoDont type="dont">
                <Img src="./pill-dont-a11y.png" alt="Pill accessibility color don't examples" className="ma-auto" />
            </DoDont>
            <p className="black-300">
...
<Wrap className="pb4">
    <Grid gutter="wide">
        <GridColumn aboveSmall={6}>
            <DoDont type="do">
                <Img src="./pill-do-icons.png" alt="Pill icons do examples" className="ma-auto" />
            </DoDont>
            <p className="black-300">
        ...
        <GridColumn aboveSmall={6}>
            <DoDont type="dont">
                <Img src="./pill-dont-icons.png" alt="Pill icons don't examples" className="ma-auto" />
            </DoDont>
            <p className="black-300">
