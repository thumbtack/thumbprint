...
See [Accessible and Inclusive Language](/content-design/inclusive-language) for more information on writing using plain language.
...
See [Accessible and Inclusive Language](/content-design/inclusive-language) for more information on formatting content.
...
See [Accessible and Inclusive Language](/content-design/inclusive-language) for more information about contractions.
...
<Grid gutter="wide">
    ...
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            Next, you’ll choose a budget–a max amount you’re able to spend weekly on leads.Next,
            you’ll choose a budget -- a max amount you’re able to spend weekly on leads.
        </DoDont>
    </GridColumn>
</Grid>
...
See our [Voice and Tone](/content-design/volce-and-tone) guidance for more information on when to use exclamation marks.
...
See [Surfaces and Elements](/content-design/surface-and-elements) for more information about writing email copy.
...
<Grid gutter="wide">
    <GridColumn aboveSmall={6}>
        <DoDont type="do" coloredHeading>
            OpportunitiesCalendarView details
        </DoDont>
    </GridColumn>
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            Opportunities.Calendar.View details.
        </DoDont>
    </GridColumn>
</Grid>
...
<Grid gutter="wide">
    <GridColumn aboveSmall={6}>
        <DoDont type="do" coloredHeading>
            ...
            through:Higher-intent customersReduced competitionLess time communicating with customers
        </DoDont>
    </GridColumn>
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            Instant Book offers better returns for the money you spend on Thumbtack
            through:higher-intent customers,reduced competition, andless time communicating with
            customers.
        </DoDont>
    </GridColumn>
</Grid>
...
<Grid gutter="wide">
    <GridColumn aboveSmall={6}>
        <DoDont type="do" coloredHeading>
            555-867-5309 :tbd: example for spelling out number after final decision> :tbd: example
            for spelling out number after final decision> :tbd: example for spelling out number
            after final decision>32 million24%
        </DoDont>
    </GridColumn>
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            (555) 867-5309 or 1-867-5309 :tbd: example for spelling out number after final decision>
            :tbd: example for spelling out number after final decision> :tbd: example for spelling
            out number after final decision>32,000,00024 percent
        </DoDont>
    </GridColumn>
</Grid>
...
<Grid gutter="wide">
    <GridColumn aboveSmall={6}>
        <DoDont type="do" coloredHeading>
            July 16, 20238am :tbd: example for :00 after final decision>8am to 12:15pm
        </DoDont>
    </GridColumn>
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            7/16/23 (unless there’s a character limit)8 a.m. or 8 am :tbd: example for :00 after
            final decision>8am – 12:15pm
        </DoDont>
    </GridColumn>
</Grid>
...
<Grid gutter="wide">
    <GridColumn aboveSmall={6}>
        <DoDont type="do" coloredHeading>
            A CRM (customer relationship management tool) helps you manage your customer’s contact
            info, messages, and your availability.
        </DoDont>
    </GridColumn>
    <GridColumn aboveSmall={6}>
        <DoDont type="dont" coloredHeading>
            A CRM helps you manage your customer’s contact info, messages, and your availability.
        </DoDont>
    </GridColumn>
</Grid>
