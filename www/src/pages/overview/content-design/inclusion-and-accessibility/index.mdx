...
export const dd_everyday_words = [
    ['Help', 'Assistance'],
    ['Get', 'Access'],
...
<DoDontTable examples={dd_everyday_words} />
...
export const dd_hidden_verbs = [
    ['Except for', 'With the exception of'],
    ['Applies to', 'Is applicable to'],
    ['Review', 'Leave a review'],
];

<DoDontTable examples={dd_hidden_verbs} />
...
export const dd_optimize_lists = [
    [
        <div>
...
<DoDontSideBySide examples={dd_optimize_lists} />
...
export const dd_inclusive = [
    [
        ...
        <div>
            <p>
                A disabled or differently abled person, handicapped person, physically challenged,
                special, special needs, mentally incapacitated/ill
            </p>
            <div>Other:</div>
            <ul>
                <li>afflicted by</li>
...
<DoDontTable examples={dd_inclusive} />
...
<DoDontTable examples={dd_anti_racism} />
...
export const dd_gender_neutral = [
    [
        'Parent or parents',
        <div>
            <div>Moms</div>
    ...
    [
        ...
        <div>
            ...
            <div>
                (These names are typically used to identify anonymous people in court cases, police
                warrants, and violent crimes.)
            </div>
        </div>,
    ],
    [
...
<DoDontTable examples={dd_gender_neutral} />
