...
<div className="flex pt4">
    <div>
        <a href="https://www.figma.com/community/plugin/748533339900865323" target="_blank">
            <img src="./plugin-contrast.png" />
        </a>
    </div>
    <div className="pl4">
        <Title size={4} headingLevel={3} className="mt0 pb1">
            Contrast
        </Title>
        <p className="black-300">
            Evaluates foreground and background color against Web Content Accessibility Guidelines
            WCAG Scan entire pages to see all text-layer color issues
        </p>
        <div>
            <a href="https://www.figma.com/community/plugin/748533339900865323" target="_blank">
                Get the{' '}
