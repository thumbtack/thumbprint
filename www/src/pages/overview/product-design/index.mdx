...
Note: This page includes documentation and information that is pertinent to the internal design team at Thumbtack.
...
[#thumbprint-questions](https://thumbtack.slack.com/archives/C0GKYQVTR)

### Office hours

Weekly hour (held over Zoom) setting aside exclusively for more qualitiative insights about how to use the system.
