---
package: '@thumbtack/tp-ui-layout-grid'
kit: grid/index.mdx
platform: scss
url: /components/grid/scss/
mdxType: componentApi
deprecated: This package was deprecated on September 11 in favor of classes from [Thumbprint Atomic](/atomic/#section-grid).
---
