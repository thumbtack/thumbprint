...
const GoodNewsIcon = (): JSX.Element => (
    <path
        fillRule="evenodd"
...
interface BannerPropTypes {
     ...
     */
    messageType: 'good' | 'bad' | 'warning' | 'note';
    /**
...
const BannerAlert = ({ children, messageType, dataTest }: BannerPropTypes): JSX.Element => (
    <div
        className={classNames({
            [styles.tpAlert]: true,
            [styles.banner]: true,
            [styles.goodNews]: startsWith(messageType, 'good'),
            [styles.badNews]: startsWith(messageType, 'bad'),
            [styles.warning]: startsWith(messageType, 'warning'),
            [styles.note]: startsWith(messageType, 'note'),
        })}
        data-test={dataTest}
    >
...
const InPageAlert = ({ children, messageType, dataTest }: InPagePropTypes): JSX.Element => (
    <div
        className={classNames({
            [styles.tpAlert]: true,
            [styles.goodNews]: startsWith(messageType, 'good'),
