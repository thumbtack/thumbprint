...
kit: modal-standard/index.mdx
platform: react
url: /components/modal-standard/react/
mdxType: componentApi
deprecated: This package was deprecated in favor of [ModalDefault](/components/modal-default/react/).
---
